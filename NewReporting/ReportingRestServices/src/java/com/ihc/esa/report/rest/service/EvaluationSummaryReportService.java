...
import com.ihc.esa.report.entity.EvaluationSummaryReport;
 ...
 * @author tssimpso
 */
@Path("evaluationSummaryReport")
@RequestScoped
public class EvaluationSummaryReportService {
     ...
     */
    public EvaluationSummaryReportService() {
    }
    ...
    public String runFindAll(@PathParam("esaId") String esaId){
        ...
        Collection<EvaluationSummaryReport> dataList = em.createNamedQuery("EvaluationSummaryReport.findAll",com.ihc.esa.report.entity.EvaluationSummaryReport.class)
                                                    .getResultList();
        ...
        report.append("<body>\n");
        report.append("<table>\n");
        report.append(EvaluationSummaryReport.getHtmlTableHeaders());
        for( EvaluationSummaryReport row: dataList ){
    ...
    @Produces({MediaType.TEXT_HTML})
    public String runTableSegment(@PathParam("esaId") String esaId){
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("jdbc/esa");
        EntityManager em = emf.createEntityManager();
        Collection<EvaluationSummaryReport> dataList = em.createNamedQuery("EvaluationSummaryReport.findAll",com.ihc.esa.report.entity.EvaluationSummaryReport.class)
                                                    .getResultList();
    ...
    public String runJSONData(){
        ...
        for( EvaluationSummaryReport row: dataList ){
            ...
            if(i == 1){ 
                ...
                dataSets.append(row.getActiveEvaluations());
                dataSets.append(",");
                dataSets.append(row.getClosedEvaluations());
                dataSets.append(",");
                dataSets.append(row.getOnHoldEvaluations());
                dataSets.append("]}");
            }
            else{
                legend.append(",\n{\"architectName\":\"");
    ...
    public String getHtml() {
        ...
        return("hello this is the evaluation summary report");
    }
