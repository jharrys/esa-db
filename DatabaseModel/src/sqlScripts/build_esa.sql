...
COMMENT ON COLUMN ESA.PROJECT.ARCHITECT_PARTY_ID IS 'Reference to the architect in the party table.  The party should be populated with a someone who has an enterprise architect role.';
