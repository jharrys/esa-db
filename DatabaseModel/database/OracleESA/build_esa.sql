...
, PURCHASING_UNIT_PRICE DOUBLE PRECISION 
...
ADD CONSTRAINT CATALOG_ITEM_CATALOG_FK FOREIGN KEY
(
  CATALOG_ID 
)
...
PROMPT alter table 'CATALOG_ITEM'
ALTER TABLE ESA.CATALOG_ITEM
ADD CONSTRAINT CATALOG_ITEM_ITEM_FK FOREIGN KEY
(
  ITEM_ID 
)
REFERENCES ESA.ITEM
...
PROMPT alter table 'CATALOG_ITEM'
ALTER TABLE ESA.CATALOG_ITEM
ADD CONSTRAINT CATALOG_ITEM_ITEM_VERSION_FK FOREIGN KEY
(
  ITEM_VERSION_ID 
)
...
ADD CONSTRAINT CONFIGURATION_CATALOG_FK FOREIGN KEY
(
...
PROMPT alter table 'CONFIGURATION_CATALOG'
ALTER TABLE ESA.CONFIGURATION_CATALOG
ADD CONSTRAINT CONFIGURATION_CATALOG_FK1 FOREIGN KEY
(
...
PROMPT alter table 'CONFIGURATION_CATALOG'
ALTER TABLE ESA.CONFIGURATION_CATALOG
ADD CONSTRAINT CONFIGURATION_CATALOG_ITEM_FK FOREIGN KEY
(
  PARENT_ITEM_ID 
)
REFERENCES ESA.ITEM
...
PROMPT alter table 'CONFIGURATION_CATALOG'
ALTER TABLE ESA.CONFIGURATION_CATALOG
ADD CONSTRAINT CONFIGURATION_CATALOG_ITEM_FK1 FOREIGN KEY
(
  ELEMENT_ITEM_ID 
)
REFERENCES ESA.ITEM
...
ADD CONSTRAINT DOCUMENT_FORM_FK FOREIGN KEY
(
  FORM_ID 
)
REFERENCES ESA.FORM
...
PROMPT alter table 'DOCUMENT'
ALTER TABLE ESA.DOCUMENT
ADD CONSTRAINT DOCUMENT_PARTY_FK FOREIGN KEY
(
...
ADD CONSTRAINT FORM_FIELD_FORM_FK FOREIGN KEY
(
  FORM_ID 
)
REFERENCES ESA.FORM
...
PROMPT alter table 'FORM_FIELD'
ALTER TABLE ESA.FORM_FIELD
ADD CONSTRAINT FORM_FIELD_LOOKUP_LIST_FK FOREIGN KEY
(
  LOOKUP_LIST_ID 
)
...
PROMPT alter table 'ITEM'
ALTER TABLE ESA.ITEM
ADD CONSTRAINT ITEM_PARTY_FK FOREIGN KEY
(
  VENDOR_PARTY_ID 
)
REFERENCES ESA.PARTY
...
ADD CONSTRAINT ITEM_UNITS_CONVERSION_ITEM_FK FOREIGN KEY
(
  ITEM_ID 
)
REFERENCES ESA.ITEM
...
ADD CONSTRAINT ITEM_VERSION_ITEM_FK FOREIGN KEY
(
  ITEM_ID 
)
REFERENCES ESA.ITEM
...
ADD CONSTRAINT QUESTION_RESPONSE_DOCUMENT_FK FOREIGN KEY
(
  DOCUMENT_ID 
)
...
PROMPT alter table 'QUESTION_RESPONSE'
ALTER TABLE ESA.QUESTION_RESPONSE
ADD CONSTRAINT QUESTION_RESPONSE_FK FOREIGN KEY
(
  FORM_FIELD_ID 
)
...
ADD CONSTRAINT REPLACEMENT_ITEM_ITEM_FK FOREIGN KEY
(
  ITEM_ID 
)
REFERENCES ESA.ITEM
...
PROMPT alter table 'REPLACEMENT_ITEM'
ALTER TABLE ESA.REPLACEMENT_ITEM
ADD CONSTRAINT REPLACEMENT_ITEM_ITEM_FK1 FOREIGN KEY
(
  REPLACEMENT_ITEM_ID 
)
REFERENCES ESA.ITEM
...
ADD CONSTRAINT ROLE_PRIVLIGES_FK FOREIGN KEY
(
  ROLE_ID 
)
REFERENCES ESA.ROLE
...
PROMPT alter table 'ROLE_SERVICE'
ALTER TABLE ESA.ROLE_SERVICE
ADD CONSTRAINT ROLE_PRIVLIGES_FK1 FOREIGN KEY
(
  SERVICE_ID 
)
...
COMMENT ON COLUMN ESA.REPLACEMENT_ITEM.ITEM_ID IS '@replacementFor';

COMMENT ON COLUMN ESA.REPLACEMENT_ITEM.REPLACEMENT_ITEM_ID IS '@replacedBy';
